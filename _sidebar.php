...
$query1 = mysqli_query($koneksi, "SELECT kepala FROM tbl_kepala WHERE id = 1");
$kepala = mysqli_fetch_assoc($query1);
...
?>
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard.php') ?>">
        ...
        <div class="sidebar-brand-text mx-3"><?php echo $kepala['kepala']; ?></div>
      </a>
      ...
      <li class="nav-item">
      	<a href="<?= base_url('kelas/index.php') ?>" class="nav-link">
