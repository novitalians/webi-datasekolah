...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_kepala WHERE id = 1");
$kelas = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tbl_kelas"));
					...
					<div class="card border-left-primary shadow h-100 py-2">
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Nama Kepala Sekolah</div>
									<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $kepala['kepala']; ?></div>
								</div>
								<div class="col-auto">
			...
			<div class="row">
				<div class="col">
					<div class="card shadow">
						<div class="card-header">Data Kelas - SMK Merpati Bandung</div>
						<div class="card-body">
							<form action="proses_ubah.php" method="POST">
								<div class="form-group">
									<label for="nama_kepala">Nama Kepala Sekolah </label>
									<input type="text" name="nama_kepala" class="form-control" autocomplete="off" required="required" value="<?php echo $kepala['kepala'] ?>">
								</div>
								<div class="form-group">
