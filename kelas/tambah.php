...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Kelas</title>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="id" class="form-control" placeholder="Masukan ID Kelas" name="id" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="kelas" class="form-control" placeholder="Masukan Nama Kelas" name="kelas" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="wali_kelas" class="form-control" placeholder="Masukan Nama Wali Kelas" name="wali_kelas" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="tahun_ajaran" id="tahun_ajaran" class="form-control" placeholder="Masukan Tahun Ajaran" required="required" autocomplete="off">
											</div>
										</div>										
										<div class="form-group">
